...
category: Pelican 
image: ![Diagram of a laptop connecting to server over ssh]({filename}/images/site-with-pelican.png)

![Diagram of a laptop connecting to server over ssh]({filename}/images/site-with-pelican.png)
