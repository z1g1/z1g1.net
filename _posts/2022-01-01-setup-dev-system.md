...
1. You can use the default shell which will install with your WSL distro but the [Microsoft Terminal](https://github.com/Microsoft/Terminal) project gives you a number of customization options.
